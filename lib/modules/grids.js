...
function buildGrids(request, module, next) {
    request.optionsScss = {'grids-bgcolor': "#abc"}
    next();
...
// function _updateGrids(request, module, types, fn) {
//     console.log("_updateGrids entered...");

//     //Read in Grids file
//     var GridsFile = path.resolve(__dirname + path.sep + '..' + path.sep + '..' + path.sep + module + '/scss/Grids.scss');
//     var fileString = fs.readFileSync(GridsFile).toString();
...
//     fs.writeFileSync(GridsFile, fileString);
