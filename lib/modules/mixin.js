...
function _replaceQuotedProperties(request, optionsScss, quoted, unicornPrefix) {
	return _replaceProperties(request, optionsScss, null, quoted, unicornPrefix);
}
function _replaceUnQuotedProperties(request, optionsScss, unquoted, unicornPrefix) {
	return _replaceProperties(request, optionsScss, unquoted, null, unicornPrefix);
}

function _replaceProperties(request, optionsScss, unquoted, quoted, unicornPrefix) {
	var i, property;
